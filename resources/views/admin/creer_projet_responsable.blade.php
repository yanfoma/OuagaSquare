                ...
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <ul class="nav-responsive nav nav-tabs"><li class="dropdown pull-right tabdrop active"><a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"><i class="glyph-icon icon-align-justify"></i> <b class="caret"></b></a></li>
                            <li class="active"><a href="#tab1" data-toggle="tab">Ajout de responsable</a></li>  
                            <li class=""><a href="#tab2" data-toggle="tab">Répertoire des responsables</a></li>   
                        </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Libelle du responsable</label>
                                                        <div class="col-sm-8">
                                            ...
                                            <table id="datatable-responsive-two" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($Responsable as $responsable) {
                                                        ?>
                                                        <tr>
                                                            <td hidden="hidden"><?php echo $responsable->id ?></td>

                                                            <td style="text-align: center">{{$responsable->libelle}}</td>
                                                            <td style="text-align: center"><a data-toggle="modal" data-target="#modifier_responsable<?php echo $responsable->id?>" class="btn btn-primary">Modifier</a> | <a href="supprimer_responsable<?php echo $responsable->id?>" class="btn btn-primary">Supprimer</a></td>

                                                            <div class="modal fade" id="modifier_responsable<?php echo $responsable->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <br/>
                                                                        <form action="enregistrer_modifier_responsable<?php echo $responsable->id;?>" method="post" class="form-horizontal" id="demo-form" data-parsley-validate="" novalidate="">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label class="col-sm-3 control-label">Resume du responsable</label>
                                                                                        <div class="col-sm-8">
                                                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                                            <input type="text" name="responsable" class="form-control" required="" value="{{$responsable->libelle}}">
                                                                                        </div>
                                                                                        @if($errors->has('responsable'))
                                                                                        {<span style="color:red">{!!$errors->first('responsable')!!}</span>}
                                                                                        @endif
